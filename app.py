...
#endpoint returning json data with statistic analysis of selected time period and city (Krakow or Brussels)
...
#endpoint returning json data with statistic analysis from selected city (Krakow or Brussels)
